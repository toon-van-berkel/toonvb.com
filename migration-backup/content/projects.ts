...
export const projects: Project[] = [
    {
        ...
        summary: 'A custom platform for campaigns, characters, lore and worldbuilding.',
        technologies: ['SvelteKit', 'TypeScript'],
        logo: '/logos/dnd-portal.svg',
        image: '/images/projects/dnd-portal.webp',
        external: 'https://www.dnd-portal.com',
        sections: [
    ...
    },
    {
        ...
        type: 'Client project',
        status: 'Published',
        summary: 'A public-facing website focused on presenting information clearly through a modern and accessible web experience.',
        technologies: ['Web development', 'Responsive design'],
        logo: '/logos/antarctica-sc.svg',
        image: '/images/projects/antarctica-sc.webp',
        external: 'http://antarctica-sc.nl/'
    }
];
